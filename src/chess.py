...
def chess_victories(chess_df):
     ...
     plt.tight_layout()
     plt.axis('equal')
     plt.savefig("images/chess_outcomes_breakdown.png")
...
def wins_versus_draws(chess_games):
    ...
    plt.tight_layout()
    plt.axis('equal')
    plt.savefig("images/wins_versus_draws.png")
...
def chess_differentials_white(chess_df):
    ...
    ax.legend();
    plt.savefig("images/white_wins_vs_draws_&_losses.png")
    white_win_percentage = (4110 /(4110+1556))*100
    white_draw_or_loss_percentage = (1556 /(4110+1556))*100
    return print({ 'White Superior Games': white_greater_100, 'White T-test':white_ttest, 'White Victories': white_victory, 'White Draws or Losses': white_draw_or_loss, 'White Win %': white_win_percentage, 'White Draw or Loss %': white_draw_or_loss_percentage, 'Black Wins': black_wins})
...
def chess_differentials_black(chess_df):
    ...
    ax.legend();
    plt.savefig("images/black_wins_vs_draws_&_losses.png")
    black_win_percentage = (3623 /(3623+1607))*100
    black_draw_or_loss_percentage = (1607 /(3623+1607))*100

    return print({' Black Superior Games': black_greater_100, 'Black T-test': black_ttest, 'Black Victories': black_victory, 'Black Draws or Losses': black_draw_or_loss, 'Black Win %': black_win_percentage, 'Black Draw or Loss %': black_draw_or_loss_percentage, 'White Wins': white_wins})
###
...
if __name__ == "__main__":
    ...
    # chess_outcome = chess_outcome_breakdown(chess_data)
    ...
    # chess_correlations = chess_correlations_spearman(chess_differentials_white(chess_data), chess_differentials_black(chess_data))
